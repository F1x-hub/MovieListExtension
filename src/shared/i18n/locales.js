    ...
    en: {
        ...
        settings: {
            ...
            updates: {
                ...
                setup_required: "Run the latest MovieListSetup.exe once to connect or upgrade automatic updates.",
                setup_button: "Connect automatic updates",
                install_latest_button: "Check and install latest version",
                install_latest_preparing: "Checking for updates...",
                install_latest_started: "Installation of version {version} started.",
                install_latest_restarting: "Version {version} is ready. Restarting the extension...",
                install_latest_succeeded: "Version {version} was installed successfully.",
                install_latest_not_safe: "The update is waiting for playback to finish.",
                playback_warning_title: "Playback is active",
                playback_warning: "Something is currently playing. Updating to version {version} may interrupt it. Continue?",
                playback_decline_button: "No, wait",
                playback_confirm_button: "Yes, update",
                install_latest_declined: "Update postponed. Playback can continue.",
                install_latest_in_progress: "Another update installation is already in progress.",
                install_latest_recovery_required: "The previous update needs recovery. Restart the computer and try again.",
                install_latest_failed: "Could not start the latest release installation.",
                install_latest_up_to_date: "You already have the latest version.",
        ...
        movie_card: {
            ...
            add_random_pool: "Add to Random pool",
            random_pool_added: "Already in Random pool",
            random_pool_error: "Couldn't update Random pool",
        ...
        movie_details: {
            ...
            rating_prompt: "Select a rating",
            rating_preview: "Preview: {rating}/10",
            rating_selected: "Your rating: {rating}/10",
            ...
            max_reactions: "You can choose up to 3 reactions per comment",
            reaction_labels: {
                like: "Like",
                love: "Love",
                laugh: "Funny",
        ...
        popup: {
            ...
            auth: {
                ...
                confirm_password_required: "Repeat your password",
                close: "Close",
                ...
                login_error: "We couldn't sign you in. Try again.",
                registration_error: "We couldn't create your account. Try again.",
    ...
    ru: {
        ...
        settings: {
            ...
            updates: {
                ...
                setup_required: "Один раз запустите последнюю MovieListSetup.exe, чтобы подключить или обновить автообновления.",
                setup_button: "Подключить автообновления",
                install_latest_button: "Проверить и установить последнюю версию",
                install_latest_preparing: "Проверка обновлений...",
                install_latest_started: "Установка версии {version} запущена.",
                install_latest_restarting: "Версия {version} готова. Перезапускаем расширение…",
                install_latest_succeeded: "Версия {version} успешно установлена.",
                install_latest_not_safe: "Обновление ожидает завершения воспроизведения.",
                playback_warning_title: "Сейчас идёт воспроизведение",
                playback_warning: "Сейчас что-то воспроизводится. Обновление до версии {version} может прервать просмотр. Продолжить?",
                playback_decline_button: "Нет, подождать",
                playback_confirm_button: "Да, обновить",
                install_latest_declined: "Обновление отложено. Воспроизведение может продолжаться.",
                install_latest_in_progress: "Другая установка обновления уже выполняется.",
                install_latest_recovery_required: "Предыдущее обновление требует восстановления. Перезагрузите компьютер и повторите попытку.",
                install_latest_failed: "Не удалось начать установку последнего релиза.",
                install_latest_up_to_date: "У вас уже установлена последняя версия.",
        ...
        movie_card: {
            ...
            add_random_pool: "Добавить в пул рандома",
            random_pool_added: "Уже в пуле рандома",
            random_pool_error: "Не удалось обновить пул рандома",
        ...
        movie_details: {
            ...
            rate_title: "Оценить",
            rating_prompt: "Выберите оценку",
            rating_preview: "Будет: {rating}/10",
            rating_selected: "Ваша оценка: {rating}/10",
            ...
            max_reactions: "Можно выбрать до 3 реакций на комментарий",
            reaction_labels: {
                like: "Нравится",
                love: "Любовь",
                laugh: "Смешно",
        ...
        popup: {
            ...
            auth: {
                ...
                login_error: "Не удалось войти. Попробуйте ещё раз.",
                registration_error: "Не удалось создать аккаунт. Попробуйте ещё раз.",
                loading_login: "Вход...",
