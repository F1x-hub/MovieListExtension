console.log('[MovieList Extension] Content script loaded for zfilms-hd.by');
...
(function() {
    ...
    const injectedScriptUrl = chrome.runtime.getURL('content-scripts/zfilms-watchlist-injected.js');
