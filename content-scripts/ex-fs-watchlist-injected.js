    ...
    function showRatingModal(movieData, currentRating = 0, currentComment = '') {
        ...
        modal.innerHTML = `
            <div class="movie-list-modal-header">
                ...
                <button class="movie-list-close-btn" aria-label="Close"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>
            </div>
        ...
        saveBtn.onclick = async (e) => {
            ...
            try {
                    ...
                    const handler = (event) => {
                        if (event.data && event.data.type === 'MOVIELIST_ADD_RATING_RESPONSE'
                            ...
                            if (event.data.success) {
                                ...
                                `;
                                successMsg.innerHTML = '<span style="display:inline-flex; align-items:center; margin-right:6px;"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></span> Rating saved: ' + selectedRating + '/10';
                ...
                saveBtn.innerHTML = '<span style="display:inline-flex;align-items:center;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"></path><polyline points="17 21 17 13 7 13 7 21"></polyline><polyline points="7 3 7 8 15 8"></polyline></svg></span><span>Save Rating</span>';
            }
        };
    }
