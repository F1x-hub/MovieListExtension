console.log('[MovieList Extension] Content script loaded for kinopoisk.ru');
...
(function() {
    ...
    const injectedScriptUrl = chrome.runtime.getURL('content-scripts/kinopoisk-watchlist-injected.js');
