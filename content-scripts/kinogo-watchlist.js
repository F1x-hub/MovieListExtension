console.log('[MovieList Extension] Content script loaded for kinogo.inc');
...
(function() {
    ...
    const injectedScriptUrl = chrome.runtime.getURL('content-scripts/kinogo-watchlist-injected.js');
